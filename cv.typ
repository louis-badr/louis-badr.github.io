...
#grid(
  ...
  rect[#text(
      weight: "semibold",
    )[Master's Degree in Engineering at ESILV & Creative Technology Master of Science at IFT]],
  ...
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
      rect[#text(accent)[⤷]],
      rect[Master focused on innovation, research and manufacturing on the format\ and in collaboration with the MIT MediaLab\ Leonard de Vinci Graduate School of Engineering - Paris La Défense - #link("esilv.fr")[esilv.fr]\ Institute for Future Techologies - #link("https://www.linkedin.com/company/ift-devinci")[LinkedIn]],
    )
  ],
  ...
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
      rect[#text(accent)[⤷]], rect[Leonard de Vinci Business School - Paris La Défense - #link("emlv.fr")[emlv.fr]],
    )
  ],

  rect[2020], rect[#text(weight: "semibold")[Semester at Dorset College Dublin]],
  rect[],
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
      rect[ #text(accent)[⤷]], rect[International exchange - Dublin - Irlande - #link("dorset.ie")[dorset.ie]],
    )
  ],
)
...
#grid(
  ...
  rect[2025-], rect[#text(weight: "semibold")[PhD Student - Human-Computer Interaction / Haptics]],
  rect[],
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
      rect[#text(accent)[⤷]],
      rect[Institute for Future Technologies - DeVinci Higher Education - Paris La Défense - #link("https://www.linkedin.com/company/ift-devinci")[LinkedIn]\ Sensorimotor Interaction Group - Max Planck Institute for Informatics - Saarbrücken - #link("https://sensint.mpi-inf.mpg.de")[sensint.mpi-inf.mpg.de]\ MSTII Doctoral School - Grenoble Alps University - #link("https://edmstii.univ-grenoble-alpes.fr")[edmstii.univ-grenoble-alpes.fr]],
    )
  ],
  ...
  rect[#text(
      weight: "semibold",
    )[Intern > Research Engineer - HapTID: Haptic technology for recovery of dexterity after stroke]],
  ...
  rect[2022-2023], rect[#text(weight: "semibold")[Master's Project - AugmenTip: Fingertip haptic feedback on a budget]],
  rect[],
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
  ...
  rect[2019-2020], rect[#text(weight: "semibold")[Student Project - DeVinci3D Big Printer]],
  rect[],
  rect(inset: 0pt)[
    #grid(
      columns: (0.5cm, 1fr),
  ...
  rect[2019-2020], rect[#text(weight: "semibold")[Charity Mission - Secours Populaire]],
